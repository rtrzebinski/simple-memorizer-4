...
func TestHandlerFetchExercises(t *testing.T) {
...
func TestHandlerFetchExercises_invalidInput(t *testing.T) {
	service := NewServiceMock()
...
func TestHandlerFetchExercises_unauthorized(t *testing.T) {
	service := NewServiceMock()
